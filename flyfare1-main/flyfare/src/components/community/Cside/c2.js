      ...
      setPosts([
        {
          ...
          description: 'Hi, I’m a 32 year old man. I belong from a very lower middle class family but I was very good in studies, so I started living outside home in metro cities away from my parents to support them. I spent 8 years away from my home town. I got scholarship through which I became engineer and got a good job in Chennai. Everything was going more than I expected my life to be. I got a call from my parents that they have planned my marriage, they got me engaged when I was 16 year old, to a girl in the village. I couldn’t say no and got married to her. My wife is a very nice human being but she is very ugly, she is way too ugly than even an uglier girl. Initially I was ok as my parents fixed me long back and she always dreamt to be with me. I thought this is my destiny. But when we started living, I hate seeing her, when I see other girls around me I feel sad and depressed. She is totally dependent on me, uneducated. I cant divorce her as my parents still live there & I wont be able to face my parents. I don’t know what to do.',
          content: '',
          daysAgo: 55,
          likes: 5,
          comments: [
  ...
  return (
    <div className="AppN1">
      ...
      <footer className="unique-footer">
        <nav className="unique-footer-nav">
          <a href="/">Home</a>
          <a href="/">About us</a>
        ...
        <p className="unique-footer-text">© Fly Fare Technologies LLP 2024. All rights reserved.</p>
      </footer>
    </div>
  );
}
