    ...
    <header className="header-custom">
      ...
      <section className="navbar">
        ...
        <nav className={isMobileMenuOpen ? 'nav-open' : ''}>
          <ul>
            <li>
              <NavLink to="/" className="login-signup-button">Home</NavLink>
            </li>
            <li>
              <NavLink to="/login" className="login-signup-button">Login/Sign up</NavLink>
            </li>
            <li>
              <NavLink to="/add" className="add-button">+</NavLink>
            </li>
          </ul>
        </nav>
