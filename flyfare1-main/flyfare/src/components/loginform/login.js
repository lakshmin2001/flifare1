...
const Form = styled.form`
  background: linear-gradient(to bottom, #f5f7fa, #ce93d8);
  padding: 40px;
  border-radius: 10px;
      ...
      <Container>
        ...
        <FormSide>
          <Form onSubmit={handleLogin} aria-live="polite">
            ...
            />
            <ErrorMessage id="username-error" visible={errors.username}>
            ...
            />
            <ErrorMessage id="password-error" visible={errors.password}>
